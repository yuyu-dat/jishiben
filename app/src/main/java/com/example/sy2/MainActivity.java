    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.action_add).setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                Intent intent = new Intent(MainActivity.this, com.example.sy2.Add.class);
        ...
        ListView.setOnItemClickListener(new AdapterView.OnItemClickListener(){      //配置ArrayList点击按钮
            ...
            public void  onItemClick(AdapterView<?> parent, View view , int position , long id){
                ...
                Intent intent = new Intent(MainActivity.this, com.example.sy2.Edit.class);
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if(EditTextSeekString.length()==0){             //查询为空，给出提示信息
                            ...
                            Intent intent = new Intent(MainActivity.this, com.example.sy2.Research.class);
